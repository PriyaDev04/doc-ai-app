...
import { 
  Upload, FileText, LogOut, Plus, MessageSquare, Loader2, 
  HardDrive, Bot, User, Trash2, Edit2, Check, X, Shield, Cpu, Lock
} from "lucide-react";
import ReactMarkdown from "react-markdown";
import { Toaster, toast } from "sonner";
...
export default function Home() {
  ...
  /* ====================================================================
     LOGGED-OUT VIEW: Public Landing Page (Google OAuth Compliant)
     ==================================================================== */
  if (!session) {
    return (
      <div className="min-h-screen flex flex-col justify-between bg-slate-50 text-slate-800">
        ...
        {/* Navigation Bar */}
        <header className="w-full bg-white border-b border-slate-200 py-4 px-6 md:px-12 flex justify-between items-center shadow-xs">
        ...
        <main className="max-w-5xl mx-auto px-6 py-12 flex-1 flex flex-col justify-center space-y-12">
          <div className="text-center space-y-4 max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight">
              Intelligent Document Analysis & AI Summarization
            </h1>
            <p className="text-lg text-slate-600 leading-relaxed">
              DocAI allows you to upload, analyze, and query local documents or files directly from your Google Drive using natural language.
            </p>
            <div className="pt-4 flex justify-center">
              <button
                onClick={handleGoogleSignIn}
                className="flex items-center justify-center gap-3 bg-white border border-slate-300 shadow-sm px-6 py-3.5 rounded-xl text-sm font-semibold text-slate-700 hover:bg-slate-100 transition cursor-pointer"
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24">
                  <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" />
                  <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" />
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-xs space-y-2">
              ...
              <h3 className="font-semibold text-slate-900">Document Processing</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Upload PDFs, Word documents, or plain text files to extract key takeaways and answer context-specific questions instantly.
              </p>
            </div>

            <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-xs space-y-2">
              <div className="p-2.5 bg-green-50 text-green-600 rounded-lg w-fit">
                <HardDrive size={20} />
              </div>
              <h3 className="font-semibold text-slate-900">Google Drive Integration</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Connect your Google Drive account to list and select read-only documents for AI contextual analysis without manual downloads.
              </p>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl border border-slate-200 shadow-xs space-y-2">
              ...
              <h3 className="font-semibold text-slate-900">Interactive AI Chat</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Ask follow-up questions, request summaries, and save continuous chat threads for future research sessions.
              </p>
            </div>
          </div>

          {/* Data Usage & Privacy Transparency */}
          <div className="p-6 bg-blue-50 border border-blue-200 rounded-xl space-y-3">
            <div className="flex items-center gap-2 text-blue-900 font-semibold">
              <Shield size={18} />
              <h3>How DocAI Uses Your Google Data</h3>
            </div>
            <p className="text-sm text-blue-800 leading-relaxed">
              When you authenticate with Google, DocAI requests read-only access (<code className="bg-blue-100 px-1 py-0.5 rounded text-xs font-mono">drive.readonly</code>) solely to allow you to select documents for analysis. We do not edit, modify, or delete your files, and your data is never shared with third parties or used for model training.
            </p>
          </div>
        </main>

        {/* Public Footer */}
        <footer className="w-full border-t border-slate-200 bg-white py-6 px-6 text-center text-xs text-slate-500 space-y-2">
  ...
  /* ====================================================================
     LOGGED-IN VIEW: Workspace Interface
     ==================================================================== */
  return (
    <div className="flex flex-col md:flex-row h-screen bg-gray-100 font-sans">
      <Toaster position="top-right" richColors />
